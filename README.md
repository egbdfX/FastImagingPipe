...
## Test
If you want to test the code, please download the files from 'ExampleInput'. Run the code by 
```
./sharedlibrary_gpu Visreal.fits Visimag.fits Bin.fits Vin.fits 4096 130816 140000000 0.0000072722 3 32 locations.fits
```
You should obtain a FITS file named ```locations.fits```.
