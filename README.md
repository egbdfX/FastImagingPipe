...
**Step 2:**
Build the FIP command-line programme with Meson. See [here](https://github.com/egbdfX/FastImagingPipe/blob/engineering/INSTALL.md) for more details.
...
```difference_image.fits``` is the difference image used for source localisation (refinement).
